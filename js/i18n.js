...
(function () {
  const translations = {
    en: {
      ...
      about_text: 'Motivated Senior Business Information Systems (BIS) student with a strong passion for software engineering and mobile application development. Specialized in building cross-platform applications using Flutter and Dart, supported by practical training and project experience. Proficient in database integration (MySQL, Firebase) and equipped with a solid foundation in Python, C#, and AI concepts. Eager to leverage my technical skills and recent internship experiences to build innovative, user-centric software solutions.',
    ...
    ar: {
      ...
      about_label: 'عنّي',
      about_title: 'من أنا',
      about_text: 'طالب في السنة النهائية بتخصص نظم معلومات الأعمال (BIS)، شغوف بهندسة البرمجيات وتطوير تطبيقات الهاتف المحمول. متخصص في بناء التطبيقات باستخدام Flutter و Dart، ومدعوم بتدريب عملي ومشاريع تطبيقية. أمتلك مهارات قوية في ربط التطبيقات بقواعد البيانات (MySQL, Firebase) وأساسيات متينة في لغات البرمجة مثل Python و C# ومفاهيم الذكاء الاصطناعي. أتطلع لتوظيف مهاراتي التقنية وخبراتي من برامج التدريب للمساهمة في ابتكار حلول برمجية تلبي احتياجات المستخدمين.',
