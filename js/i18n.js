...
(function () {
  const translations = {
    en: {
      ...
      about_text: 'A highly motivated Business Information Systems senior and Software Developer specializing in Flutter, C#, and Firebase. Experienced in building full-stack mobile applications, including student networking platforms and virtual economy systems. Passionate about integrating AI technologies and leveraging strong problem-solving skills to deliver scalable, user-centric digital solutions.',
    ...
    ar: {
      ...
      about_label: 'عنّي',
      about_title: 'من أنا',
      about_text: 'مطور برمجيات وطالب بالسنة النهائية في تخصص نظم معلومات الأعمال (BIS)، متخصص في Flutter و C# و Firebase. أمتلك خبرة عملية في بناء تطبيقات الموبايل المتكاملة من الصفر، مثل منصات التواصل وأنظمة تبادل الخدمات. شغوف بدمج تقنيات الذكاء الاصطناعي وتوظيف مهاراتي في حل المشكلات لتطوير حلول رقمية فعالة وقابلة للتوسع.',
